...
keyboard.add_hotkey("f+d", lambda: keyboard1("t"))
keyboard.add_hotkey("f+s", lambda: keyboard1("u"))
keyboard.add_hotkey("f+a", lambda: keyboard1("v"))
keyboard.add_hotkey("a+a", lambda: keyboard1("w"))
keyboard.add_hotkey("s+s", lambda: keyboard1("x"))
keyboard.add_hotkey("d+d", lambda: keyboard1("y"))
keyboard.add_hotkey("f+f", lambda: keyboard1("z"))
...
keyboard.add_hotkey("f+d+ space", lambda: keyboardcapital("T"))
keyboard.add_hotkey("f+s+ space", lambda: keyboardcapital("U"))
keyboard.add_hotkey("f+a+ space", lambda: keyboardcapital("V"))
keyboard.add_hotkey("a+a+ space", lambda: keyboardcapital("W"))
keyboard.add_hotkey("s+s+ space", lambda: keyboardcapital("X"))
keyboard.add_hotkey("d+d+ space", lambda: keyboardcapital("Y"))
keyboard.add_hotkey("f+f+ space", lambda: keyboardcapital("Z"))
